...
LABEL org.opencontainers.image.description="QuickVina2, fpocket, Meeko, Boltz-2, AmberTools, PACKMOL-Memgen, MDAnalysis and CUDA GROMACS in one audited runtime"
